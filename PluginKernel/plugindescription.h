...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_5F37159E668A48A9A6AA97AB1894982E
#define AU_COCOA_VIEW_NAME AUCocoaView_5F37159E668A48A9A6AA97AB1894982E
...
const char* kAAXBundleID = "rackafxuser.aax.SynthUno.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.SynthUno.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.SynthUno.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Synth Uno";     // 31 chars max for AAX
const char* kShortPluginName = "Synth Uno";    // 15 chars max for AAX
const char* kAUBundleName = "Synth Uno";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'abcd'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{5F37159E-668A-48A9-A6AA-97AB1894982E}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'abcd';
