...
public:
	WaveTableData() 
	{
		...
		WaveTableBank* bank_0 = new WaveTableBank;	// bank means a set of 32 waveforms
		...
		for (int i = 0; i < MAX_NUM_OSC_WAVES; i++)
		{
			...
			switch (i)
			{
				...
				case BANK_0_WAVE_1:
				{
					...
					wt->initWithBrickFile("C:\\PLUGIN PROJECTS\\Synth Uno\\PluginObjects\\wavetables\\analog_square_1.tbl");
					break;
				}
				case PARABOLIC_WAVE:
				{
